...
export default function NotFoundPage() {
  return (
    <div>
      <Head>
        <title>Whoops - Kreative Templates</title>
        <meta
          name="description"
          content="Kreative Templates - Markdown templates for Obsidian note taking application and more"
        />
      ...
      <main>
        ...
        <div className="mx-auto max-w-max">
          ...
          <Image src="/notfound.gif" width={404} height={384} alt="404" className="h-44 w-auto" />
